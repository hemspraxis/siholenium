...
public class AsignacionLineaTecnologicaPage extends Page<AsignacionLineaTecnologicaPage> {
	...
	@FindBy(how = How.ID, using = "formTabla:j_idt64")
	private WebElement nuevoBtn;
	
	@FindBy(how = How.ID, using = "formTabla:j_idt65")
	...
	@FindBy(how = How.ID, using = "formDatos:j_idt44")
	private WebElement guardarBtn;

	@FindBy(how = How.ID, using = "formDatos:j_idt46")
	...
	@FindBy(how = How.ID, using = "formDatos:j_idt45")
