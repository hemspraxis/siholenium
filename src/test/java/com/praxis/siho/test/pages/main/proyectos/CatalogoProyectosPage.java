...
public class CatalogoProyectosPage extends Page<CatalogoProyectosPage>{
    ...
    @FindBy(how = How.ID, using = "formCatalogodeProyectos:j_idt39:selectOneMenu3_label")
    private WebElement proyectoLstLabel;
    int random = generateRandomNumberFromAToZ(2, 90);
    private String projectOptionXpath = "//*[@id=\"formCatalogodeProyectos:j_idt39:selectOneMenu3_panel\"]/div/ul/li["+random+"]";
    
    @FindBy(how = How.ID, using = "formCatalogodeProyectos:j_idt36")
    private WebElement nuevoBtn;

    @FindBy(how = How.ID, using = "formCatalogodeProyectos:j_idt37")
  ...
  //@FindBy(how = How.XPATH, using ="//*[@id=\"formCatalogoProyectos:calendar_fechaVig\"]/button/span[1]")
    @FindBy(how = How.XPATH, using ="//*[@id=\"formCatalogoProyectos:calendar_fechaVig_input\"]/button/span[1]")
    ...
    @FindBy(how = How.ID, using = "formCatalogodeProyectos:table:0:j_idt75")
