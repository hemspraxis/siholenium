...
public class CatalogoDefectosPage extends Page<CatalogoDefectosPage> {
    ...
    @FindBy(how = How.ID, using = "formTablaCatDefectos:j_idt64")
    private WebElement nuevoBtn;
    
    @FindBy(how = How.ID, using = "formTablaCatDefectos:j_idt65")
    ...
    @FindBy(how = How.ID, using = "formCatDefectos:j_idt44")
    private WebElement guardarBtn;

    @FindBy(how = How.ID, using = "formCatDefectos:j_idt46")
