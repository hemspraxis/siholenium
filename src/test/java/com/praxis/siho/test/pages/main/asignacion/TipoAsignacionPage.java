...
public class TipoAsignacionPage extends Page<TipoAsignacionPage> {
	...
	@FindBy(how = How.ID, using = "formTabla:j_idt67")
	private WebElement nuevoBtn;
	
	@FindBy(how = How.ID, using = "formTabla:j_idt68")
	...
	@FindBy(how = How.ID, using = "formDatos:j_idt47")
	private WebElement guardarBtn;

	@FindBy(how = How.ID, using = "formDatos:j_idt49")
	private WebElement atrasBtn;
	
	@FindBy(how = How.ID, using = "formDatos:j_idt48")
