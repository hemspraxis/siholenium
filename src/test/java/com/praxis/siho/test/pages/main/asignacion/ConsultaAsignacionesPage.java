...
public class ConsultaAsignacionesPage extends Page<ConsultaAsignacionesPage> {
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"formConsultaHorarios:j_idt59\"]/h3")
	private WebElement busquedaAccordion;

	@FindBy(how = How.ID, using = "formConsultaHorarios:j_idt59:cboRecursos_label")
	private WebElement recursoLstLabel;
	@FindBy(how = How.ID, using = "formConsultaHorarios:j_idt59:cboRecursos_panel")
	...
	@FindBy(how = How.ID, using = "formConsultaHorarios:j_idt59:cboEstatusRec_label")
	private WebElement estatusRecLabel; //list label

	@FindBy(how = How.ID, using = "formConsultaHorarios:j_idt59:cboEstatusRec_panel")
	...
	@FindBy(how = How.ID, using = "formConsultaHorarios:j_idt59")
	...
	public Map seleccionarRecursoUtil(){
		...
		try {
			...
			String randomRecursoOptionXpath = "//*[@id=\"formConsultaHorarios:j_idt59:cboRecursos_panel\"]/div/ul/li[" + generateRandomNumberFromAToZ(2, 222) + "]";
			...
			waitForWebElementDisplayed(divMod);
			Thread.sleep(8000);
	...
	public boolean asignarCveProyectoARecurso() {
		...
		try {
			...
			selectValueOnPrimefacesListInLoop(estatusRecLabel, estatusRecPanel, "Activo");
	...
	public boolean asignarCveProyectoInactivoARecurso(){
		boolean success = false;
		try {
			String fechaIngresoRec, fechaFinRec;
			//select 'inactivo' state from list 'estatus rec'
