...
public class PSPCruds extends BrowserBehaviour {
	public List<String> agregarRegistro(WebElement nuevoBtn, WebElement claveTxt, WebElement nombreTxt,
			WebElement descripcionTxt, WebElement guardarBtn, WebElement responseMessageDiv, String clave,
	...
	public static class CatalogosEstimacionTamanio extends BrowserBehaviour {
		...
		public List<String> agregarRegistro(WebElement nuevoBtn, WebElement tipoTxt, WebElement guardarBtn,
				WebElement responseMessageDiv, String nombre) {
			safeClick(nuevoBtn);
