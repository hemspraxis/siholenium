...
public class PuntualidadAsistenciaPage extends Page<PuntualidadAsistenciaPage> {
    ...
    @FindBy(how = How.ID, using = "j_idt41:selectOneMenuRecursos_label")
    private WebElement recursoLstLabel;
    
    @FindBy(how = How.ID, using = "j_idt41:selectOneMenuRecursos_panel")
    private WebElement recursoLstPanel;

    @FindBy(how = How.ID, using = "j_idt41:tableHorarios")
    private  WebElement registryTable;

    @FindBy(how = How.ID, using = "j_idt41:tableHorarios_data")
    private WebElement registryTbody;

    @FindBy(how = How.ID, using = "j_idt41:messages")
    ...
    public String modificarHorasRegistradas(){
        ...
        System.out.println("anybody: " + registros.get(5).getTagName());
        System.out.println("anybody: possible " + navigateForWebElement(registros.get(5), "td:10").getText());
        WebElement editarBtn = navigateForWebElement(registros.get(5), "td:10", "span:0");
        WebElement checkBtn  = navigateForWebElement(registros.get(5), "td:10", "span:1");

        System.out.println("one");
        System.out.println(editarBtn.getTagName());
        System.out.println(checkBtn.getTagName());
        WebElement cancelBtn = navigateForWebElement(registros.get(5), "td:10", "span:2");
        ...
        for (WebElement registro : registros){
            ...
            if (fecha != null && fecha.equals("01/10/2015")){
        ...
        WebElement entradaTxt = driver.findElement(By.id("j_idt41:tableHorarios:5:j_idt62"));
        System.out.println("two");
        WebElement salidaTxt  = driver.findElement(By.id("j_idt41:tableHorarios:5:j_idt67"));
